      ...
      <div className="max-w-[1050px] mx-auto px-5">
        ...
        >
          <div className="z-10 max-w-sm">
            ...
            <Link
              to="/catalog/vetapteka"
              className="inline-flex items-center gap-2 px-6 py-3 text-sm font-medium bg-white rounded-lg hover:bg-orange-50 hover:shadow-md active:scale-95 transition-all duration-150 border-none cursor-pointer no-underline"
              style={{ color: "#FE9015" }}
            >
              На сайт ветклиники
