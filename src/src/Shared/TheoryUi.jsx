// ─── THEORY UI — barcha theory komponentlar ───────────────────────────────────
// Shared/TheoryUi.jsx — yagona fayl, ikki joydan import qilish shart emas

// ─── THEORIES PAPKASI UCHUN (H, P, Code, Pre, Table, Note, TheoryWrap) ────────
...
// ─── SHARED PAPKASI UCHUN (TH, TP, TC, TPre, TTable, TNote, TheoryBlock) ──────
// Alias lar — eski importlar ishlashda davom etadi

export const TH = H;
export const TP = P;
export const TC = Code;
export const TPre = Pre;
export const TTable = Table;
export const TNote = Note;
export const TheoryBlock = TheoryWrap;
